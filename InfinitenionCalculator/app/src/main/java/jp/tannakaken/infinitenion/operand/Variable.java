...
class Variable implements Operand {
	...
	@Override
	public Constant add(final Operand aOperand) throws CalculatingException {
		return mInterior.add(aOperand);
	}
	
	@Override
	public Constant mul(final Operand aOperand) throws CalculatingException {
		return mInterior.mul(aOperand);
	}
	
	@Override
	public Constant negate() throws CalculatingException {
		return mInterior.negate();
	}
	@Override
	public Constant div(final Operand aOperand) throws CalculatingException {
