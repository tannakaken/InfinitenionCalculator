...
interface Operand {
	 ...
	 * @return 和
	 */
	Constant add(Operand aOperand) throws CalculatingException;
	/**
	 * {@link Operand#getHeight()}の値が0のインスタンス同士にのみ定義される。
	 ...
	 * @return 積
	 */
	Constant mul(Operand aOperand) throws CalculatingException;
	/**
	 * {@link Operand#getHeight()}の値が0のインスタンスにのみ定義される。
	 * それ以外は、staticメソッド{@link ResultantFactory#negate()}によって計算される。
	 * @return 符号反転
	 */
	Constant negate() throws CalculatingException;
	/**
	 * {@link Operand#getHeight()}の値が0のインスタンスにのみ定義される。
	 ...
	 * @return 商
	 */
	Constant div(Operand aOperand) throws CalculatingException;
	/**
	 * {@link Operand#getHeight()}の値が0のインスタンスにのみ定義される。
